...
public class AutenticacaoViaTokenFilter extends OncePerRequestFilter{
	...
	private void autenticarUsuario(String token) {
		Integer idUsuario = tokenService.getIdDono(token);
		Usuario usu = usuarioRepository.findById(idUsuario).get();
		UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(usu, null, usu.getAuthorities());
